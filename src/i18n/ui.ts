...
export const ui = {
	ko: {
		...
		home: {
			...
			note: '배움이 나를 쓰러트리고, 다시 일으킴!',
			title: '배움에 넘어지고, 구조로 다시 일어납니다.',
			intro:
				'사용자의 문제를 구조로 풀고, 함께 이해할 수 있게 만드는 iOS 개발자 김서영입니다. 모르는 것 앞에서 기꺼이 넘어지고, 배운 것을 다음 사람이 딛고 설 수 있는 형태로 남깁니다.',
	...
	en: {
		...
		home: {
			...
			note: 'Learning knocks me down, then gets me back up!',
			title: 'Learning knocks me down; structure helps me rise again.',
			intro:
				"I'm Seoyeong Kim, an iOS developer who turns user problems into structures people can understand together. I willingly stumble into what I do not know, then leave what I learn in a form someone else can stand on.",
