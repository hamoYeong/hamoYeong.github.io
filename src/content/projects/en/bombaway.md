...
team:
  type: team
  description: This is a private Apple Developer Academy C3 team project. I distinguish the team's outcome from my publishable individual contribution.
...
context: This private Apple Developer Academy C3 team project ran from May through June 2026. It summarizes publishable product flows and my contribution without reproducing repository code or internal collaboration details.
user: The intended player wants a short multiplayer game that involves moving through the same physical space without watching the screen continuously.
contributions:
...
challenges:
  ...
  - Distance and direction quality varied with device orientation and the environment, so raw sensor values could not serve directly as game rules.
  - Without an automated test target or publishable playtest evidence, implementation completeness and play quality remain separate claims.
technologies:
  - Swift
  - SwiftUI
  ...
  - PHASE
outcomes:
  - Verified repository flows for room creation and joining, role assignment, synchronized countdown, bomb transfer, results, and the next round.
  - Connected distance and direction, sensor fallback, and spatial audio into a working game flow.
  - Playtest results and usage metrics are not presented as outcomes without publishable evidence.
whatIWouldChange:
